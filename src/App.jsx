...
const App = () => {
  ...
  const LINKS = {
    VIP_HEBDO: "https://votre-boutique.sellfy.store/p/votre-lien-vip", // METS TON LIEN ICI
    BIBLE: "https://votre-boutique.sellfy.store/p/votre-lien-bible",     // METS TON LIEN ICI
    FICHE_UNITAIRE: "https://votre-boutique.sellfy.store/p/votre-lien-fiche" // METS TON LIEN ICI
  };

  const stats = [
    { label: "ROI Moyen", value: "+51%", icon: <TrendingUp className="w-5 h-5 text-orange-500" /> },
    { label: "Membres Team", value: "1500+", icon: <Users className="w-5 h-5 text-orange-500" /> },
      ...
      <section className="relative pt-48 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 bg-slate-900 border border-slate-800 px-4 py-1.5 rounded-full mb-8">
            <span className="relative flex h-2 w-2 text-orange-500">
               ●
            </span>
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
            <a href={LINKS.VIP_HEBDO} className="w-full sm:w-auto bg-orange-600 hover:bg-orange-700 text-white px-10 py-5 rounded-2xl font-black text-lg flex items-center justify-center gap-2 transition-all shadow-xl shadow-orange-600/30 group">
            ...
            <div className="p-8 md:p-16">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                <div className="lg:col-span-2 space-y-8">
                  <p className="text-slate-300 leading-relaxed text-xl font-medium text-center md:text-left">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div className="bg-slate-900 border border-slate-800 p-12 rounded-[3rem] flex flex-col justify-between hover:border-orange-500/50 transition-all">
                 ...
                 <div className="flex items-center justify-between">
                    ...
                    <a href={LINKS.BIBLE} className="bg-slate-800 hover:bg-slate-700 px-8 py-4 rounded-2xl font-black transition-all border border-slate-700 uppercase text-[10px] tracking-widest">Commander</a>
                 </div>
              </div>
